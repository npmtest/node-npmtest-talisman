...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-talisman/node_modules/talisman/phonetics/french/phonetic.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-talisman/node_modules/talisman/phonetics/french/phonetic.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-talisman/node_modules/talisman/phonetics/french/</a> &#187; phonetic.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function squeeze(word) {</span>
<span class="cstat-no" title="statement not covered" >  return word.replace(/(.)\1/g, '$1');</span>
}
&nbsp;
/**
 * Rules.
 ...
 */
<span class="fstat-no" title="function not covered" >function phonetic(word) {</span>
<span class="cstat-no" title="statement not covered" >  if (typeof word !== 'string') <span class="cstat-no" title="statement not covered" >throw Error('talisman/phonetics/french/phonetic: the given word is not a string.');</span></span>
&nbsp;
  // Preparing the word
<span class="cstat-no" title="statement not covered" >  word = word.toUpperCase().replace(/Œ/g, 'OEU').replace(/Æ/g, 'E').replace(/Ç/g, 'S');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  word = (0, _deburr2.default)(word).replace(/[^A-Z]/g, '');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var code = word;</span>
&nbsp;
  // First preprocessing
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = FIRST_PREPROCESSING.length; i &lt; l; i++) {</span>
<span class="cstat-no" title="statement not covered" >    var _FIRST_PREPROCESSING$ = FIRST_PREPROCESSING[i],</span>
        pattern = _FIRST_PREPROCESSING$[0],
        replacement = _FIRST_PREPROCESSING$[1];
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >    code = code.replace(pattern, replacement);</span>
  }
&nbsp;
  // Squeezing
<span class="cstat-no" title="statement not covered" >  code = squeeze(code);</span>
&nbsp;
  // Is the word an exception?
<span class="cstat-no" title="statement not covered" >  var exception = EXCEPTIONS[code];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  for (var _i = 0, _l = SECOND_PREPROCESSING.length; _i &lt; _l; _i++) {</span>
<span class="cstat-no" title="statement not covered" >    var _SECOND_PREPROCESSING = SECOND_PREPROCESSING[_i],</span>
...
&nbsp;
  // Applying rules
<span class="cstat-no" title="statement not covered" >  for (var _i2 = 0, _l2 = RULES.length; _i2 &lt; _l2; _i2++) {</span>
<span class="cstat-no" title="statement not covered" >    var _RULES$_i = RULES[_i2],</span>
        pattern = _RULES$_i[0],
...
&nbsp;
  // First endings
<span class="cstat-no" title="statement not covered" >  for (var _i3 = 0, _l3 = FIRST_ENDINGS.length; _i3 &lt; _l3; _i3++) {</span>
<span class="cstat-no" title="statement not covered" >    var _FIRST_ENDINGS$_i = FIRST_ENDINGS[_i3],</span>
...
<span class="cstat-no" title="statement not covered" >  var backupCode = code;</span>
&nbsp;
  // Second endings
<span class="cstat-no" title="statement not covered" >  for (var _i4 = 0, _l4 = SECOND_ENDINGS.length; _i4 &lt; _l4; _i4++) {</span>
<span class="cstat-no" title="statement not covered" >    var _SECOND_ENDINGS$_i = SECOND_ENDINGS[_i4],</span>
...
&nbsp;
  // Special cases
<span class="cstat-no" title="statement not covered" >  if (code === 'FUEL') <span class="cstat-no" title="statement not covered" >code = 'FIOUL';</span></span>
&nbsp;
  // If the code is "O" we return it (only acceptable code with only 1 letter)
<span class="cstat-no" title="statement not covered" >  if (code === 'O') <span class="cstat-no" title="statement not covered" >return code;</span></span>
&nbsp;
  // Attempting to save short codes
<span class="cstat-no" title="statement not covered" >  if (code.length &lt; 2) {</span>
&nbsp;
    // Abbreviations
<span class="cstat-no" title="statement not covered" >    if (ABBREVIATION_REGEX.test(word)) <span class="cstat-no" title="statement not covered" >return word;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (SIMPLE_WORDS_REGEX.test(word)) {</span>
<span class="cstat-no" title="statement not covered" >      if (word.length === 3 || word.length === 4) <span class="cstat-no" title="statement not covered" >return word.slice(0, -1);</span></span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (backupCode.length &gt; 1) <span class="cstat-no" title="statement not covered" >return backupCode;</span></span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (code.length &gt; 1) <span class="cstat-no" title="statement not covered" >return code;</span></span>
&nbsp;

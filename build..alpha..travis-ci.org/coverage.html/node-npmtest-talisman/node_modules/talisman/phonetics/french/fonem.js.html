...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-talisman/node_modules/talisman/phonetics/french/fonem.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-talisman/node_modules/talisman/phonetics/french/fonem.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-talisman/node_modules/talisman/phonetics/french/</a> &#187; fonem.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function fonem(name) {</span>
<span class="cstat-no" title="statement not covered" >  if (typeof name !== 'string') <span class="cstat-no" title="statement not covered" >throw Error('talisman/phonetics/french/fonem: the given name is not a string.');</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var code = (0, _deburr2.default)(name).toUpperCase().replace(/[^A-Z]/, '');</span>
&nbsp;
  // Applying rules in order
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = ORDERED_RULES.length; i &lt; l; i++) {</span>
<span class="cstat-no" title="statement not covered" >    var _ORDERED_RULES$i = ORDERED_RULES[i],</span>
...
&nbsp;
  // Fixing rules
<span class="cstat-no" title="statement not covered" >  for (var _i = 0, _l = FIXING_RULES.length; _i &lt; _l; _i++) {</span>
<span class="cstat-no" title="statement not covered" >    var _code;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    code = (_code = code).replace.apply(_code, _toConsumableArray(FIXING_RULES[_i]));</span>

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-talisman/node_modules/talisman/stemmers/french/carry.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-talisman/node_modules/talisman/stemmers/french/carry.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-talisman/node_modules/talisman/stemmers/french/</a> &#187; carry.js</div>
</div>
<div class="body">
 ...
 * Helpers.
 */
<span class="fstat-no" title="function not covered" >function computeM(string) {</span>
&nbsp;
  // Removing leading consonants
<span class="cstat-no" title="statement not covered" >  string = string.replace(LC, '').replace(TV, '');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return (string.match(M) || []).length;</span>
}
&nbsp;
/**
 * Rules.
 ...
 */
<span class="fstat-no" title="function not covered" >function applyRules(rules, stem) {</span>
&nbsp;
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (stem.slice(-pattern.length) === pattern) {</span>
<span class="cstat-no" title="statement not covered" >      var newStem = stem.slice(0, -pattern.length) + replacement,</span>
          m = computeM(newStem);
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (m &lt;= min) <span class="cstat-no" title="statement not covered" >continue;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return newStem;</span>
    }
  }
&nbsp;
 ...
 * @return {string}      - The resulting stem.
 */
<span class="fstat-no" title="function not covered" >function carry(word) {</span>
<span class="cstat-no" title="statement not covered" >  var stem = word.toLowerCase();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  stem = applyRules(STEP1, stem);</span>
<span class="cstat-no" title="statement not covered" >  stem = applyRules(STEP2, stem);</span>
<span class="cstat-no" title="statement not covered" >  stem = applyRules(STEP3, stem);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return stem;</span>
}

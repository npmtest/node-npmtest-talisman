...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-talisman/node_modules/talisman/tokenizers/hyphenation/liang.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-talisman/node_modules/talisman/tokenizers/hyphenation/liang.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-talisman/node_modules/talisman/tokenizers/hyphenation/</a> &#187; liang.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">25798</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4938</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4938</span>
<span class="cline-any cline-yes">20860</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">20860</span>
<span class="cline-any cline-yes">20860</span>
<span class="cline-any cline-neutral">&nbsp;</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function liang(word) {</span>
&nbsp;
  // If the word is too short, it doesn't need to be hyphenated
<span class="cstat-no" title="statement not covered" >  if (word.length &lt;= 4) <span class="cstat-no" title="statement not covered" >return [word];</span></span>
&nbsp;
  // Checking whether the word is an exception
<span class="cstat-no" title="statement not covered" >  var exception = EXCEPTIONS[word.toLowerCase()];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  var code = '.' + word.toLowerCase() + '.',</span>
      points = (0, _vectors.vec)(code.length + 1, 0);
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var _i = 0, _l = code.length; _i &lt; _l; _i++) {</span>
<span class="cstat-no" title="statement not covered" >    var _branch = TREE;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var j = _i; j &lt; _l; j++) {</span>
<span class="cstat-no" title="statement not covered" >      var _character = code[j];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (_character in _branch) {</span>
<span class="cstat-no" title="statement not covered" >        _branch = _branch[_character];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_branch.points) {</span>
<span class="cstat-no" title="statement not covered" >          for (var k = 0, n = _branch.points.length; k &lt; n; k++) {</span>
<span class="cstat-no" title="statement not covered" >            points[_i + k] = Math.max(points[_i + k], _branch.points[k]);</span>
          }
        }
      } else {
...
<span class="cstat-no" title="statement not covered" >  points[1] = 0;</span>
<span class="cstat-no" title="statement not covered" >  points[2] = 0;</span>
<span class="cstat-no" title="statement not covered" >  points[points.length - 2] = 0;</span>
<span class="cstat-no" title="statement not covered" >  points[points.length - 3] = 0;</span>
&nbsp;
  // Building the tokens
<span class="cstat-no" title="statement not covered" >  var tokens = [''];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var _i2 = 0, _l2 = word.length; _i2 &lt; _l2; _i2++) {</span>
<span class="cstat-no" title="statement not covered" >    tokens[tokens.length - 1] += word[_i2];</span>
<span class="cstat-no" title="statement not covered" >    if (points[_i2 + 2] % 2) <span class="cstat-no" title="statement not covered" >tokens.push('');</span></span>
  }
&nbsp;

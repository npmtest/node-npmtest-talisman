...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-talisman/node_modules/talisman/phonetics/caverphone.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-talisman/node_modules/talisman/phonetics/caverphone.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-talisman/node_modules/talisman/phonetics/</a> &#187; caverphone.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  while (code.length &lt; 10) {</span>
<span class="cstat-no" title="statement not covered" >    code += '1';</span>
  }<span class="cstat-no" title="statement not covered" >return code.slice(0, 10);</span>
}
&nbsp;
/**
 ...
 */
<span class="fstat-no" title="function not covered" >function caverphone(rules, name) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (typeof name !== 'string') <span class="cstat-no" title="statement not covered" >throw Error('talisman/phonetics/caverphone: the given name is not a string.');</span></span>
&nbsp;
  // Preparing the name
<span class="cstat-no" title="statement not covered" >  name = (0, _deburr2.default)(name).toLowerCase().replace(/[^a-z]/g, '');</span>
&nbsp;
  // Applying the rules
...
<span class="cstat-no" title="statement not covered" >  return pad(name);</span>
}
&nbsp;
/**
 * Exporting functions.
